package main.java.com.jdfc.agent;
 ...
 * it is considered as a plain resource that must be configured for the application under test (target JVM). The agent
 * JAR does not provide any public Java API.
 */
public class AgentJar {
     ...
     */
    private static final String RESOURCE = "/jdfcagent.jar";

    private static final String ERRORMSG = String
            .format("The resource %s has not been found. Please see "
                    + "/com.jdfc.agent/README.TXT for details.", RESOURCE);
    ...
    /**
     * Return the content of the JAR file as a stream.
     *
     * @return content of JAR file
     */
    ...
    /**
     * Extract the JDFC agent JAR and put it into a temporary location. This
    ...
    /**
     * Extract the JDFC agent JAR and put it into the specified location.
     *
     * @param destination
     *              Location to write JDFC Agent Jar to. Must be writeable
     *
     * @throws IOException
     *              Unable to unpack agent jar
     */
