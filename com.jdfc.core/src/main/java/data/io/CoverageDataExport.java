...
//        Set<ClassData> cDataSet = exDataSet.stream()
//                .filter(data -> data instanceof ClassData)
...
//                ClassData classData = (ClassData) classExecutionDataNode.getData();
//                classData.computeCoverage();
//                classExecutionDataNode.aggregateDataToRootRecursive();
//                CoverageDataExport.dumpClassExecutionDataToFile(classData);
////            } catch (IOException e) {
////                e.printStackTrace();
...
//     */
//    public static void dumpClassExecutionDataToFile(final ClassData pClassData) throws ParserConfigurationException, TransformerException {
//        String outPath = String.format("%s%starget%sjdfc", System.getProperty("user.dir"), File.separator, File.separator);
//        File JDFCDir = new File(outPath);
//        if (!JDFCDir.exists()) {
//            JDFCDir.mkdirs();
//        }
//
//        String filePath = String.format("%s%s%s.json", outPath, File.separator, pClassData.getRelativePath());
//        File file = new File(filePath);
//        file.getParentFile().mkdirs();
//
//        ObjectMapper objectMapper = new ObjectMapper();
//        try {
//            objectMapper.writeValue(file, pClassData);
//        } catch (IOException e) {
//            throw new RuntimeException(e);
//        }
    }
