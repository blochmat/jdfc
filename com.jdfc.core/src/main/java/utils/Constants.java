...
public class Constants {
    ...
    public static final String FIELD_TEST_DATA_DESCRIPTOR = "Ljava/util/Set;";
    public static final String FIELD_TEST_DATA_SIGNATURE = "Ljava/util/Set<Ljava/lang/String;>;";
