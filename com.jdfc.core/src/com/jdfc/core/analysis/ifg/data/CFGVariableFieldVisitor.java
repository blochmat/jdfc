...
class CFGVariableFieldVisitor extends FieldVisitor {
    ...
    private final CFGVariableClassVisitor classVisitor;

    public CFGVariableFieldVisitor(final CFGVariableClassVisitor pClassVisitor,
